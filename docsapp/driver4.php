<?php 
    ...
    CURLOPT_URL => "http://127.0.0.1:3000/fetchRides?dId=4",
  ...
  if(isset($_POST['rideId']))
  {
    ...
    curl_setopt_array($curl, array(
    CURLOPT_URL => "http://127.0.0.1:3000/submitRide?driverId=4&rideId=".$newstring,
    CURLOPT_RETURNTRANSFER => true,
    CURLOPT_ENCODING => "",
    CURLOPT_MAXREDIRS => 10,
    CURLOPT_TIMEOUT => 30,
  ...
  <table class="table table-bordered">
    ...
    <tbody>
      ...
      <?php for($i = 0; $i < sizeOf($arr); $i++) {
        ...
        ?>
        <form method='post' action="driver4.php">
        <tr>
          <td>
